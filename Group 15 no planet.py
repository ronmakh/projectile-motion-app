...
smileimage = PhotoImage(file = 'smilemile.gif')
motionimage = PhotoImage(file = 'smilemile.gif')
...
def abc():
    ...
    #yayaya = cv.create_image(0,0, image = motionimage, anchor = NW)
    #cv.pack()
...
def func_of_AppPage():
    ...
    photo = PhotoImage(file = 'sunnydaytjn.gif')
...
def func_of_ConclusionPage():
    ...
    nani = kartik.create_image(0,0, image = smileimage, anchor = NW)
    kartik.pack()
